...
import { X, User, Settings, LogOut, ChevronLeft, AlertTriangle, Mail, Shield, Lock, Clock, Globe, Home, Crown, Zap } from 'lucide-react';
...
const ProfileModal = ({ isOpen, onClose, onOpenHousehold }) => {
    ...
    const userBadges = (BADGES || []).map(b => {
        try {
            return {
                ...b,
                unlocked: b.condition ? b.condition({
                    totalConsumed,
                    totalWasted,
                    totalProcessed,
                    efficiency,
                    consumedList: stats.consumed, // [NEW] Pass full list
                    streak // [NEW] Pass streak
                }) : false
            };
        } catch (error) {
                        ...
                        >
                            ...
                            <div style={{ padding: '2rem', textAlign: 'center' }}>
                                ...
                                {currentUser ? (
                                    ...
                                    <>
                                        <h2 className="text-gradient" style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>
                                            {showEmailForm ? (isRegistering ? 'Create Account' : 'Welcome Back') : 'Welcome to Fruitcyclopedia'}
                                        </h2>
                                        <p style={{ color: 'var(--color-text-muted)', marginBottom: '2rem' }}>
